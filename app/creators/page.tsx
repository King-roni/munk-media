        ...
        <div className="container-max">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Access an exclusive network of vetted influencers and content creators who align perfectly with your brand's values and target audience.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="luxury-card max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Are you a content creator looking to work with premium brands? 
                Apply to join our exclusive network and unlock new opportunities.
              </p>
