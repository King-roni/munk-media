...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add slide animations to service cards
    ...
    // Add scale animation to portfolio items
    const portfolioItems = document.querySelectorAll('.portfolio-item');
...
document.querySelectorAll('.portfolio-item').forEach(item => {
    item.addEventListener('click', function() {
        ...
        const overlay = this.querySelector('.portfolio-overlay h4');
        if (overlay) {
            showNotification(`Opening ${overlay.textContent}...`, 'info');
        }
    });
});
...
// Add random color variations to floating cards
document.addEventListener('DOMContentLoaded', () => {
